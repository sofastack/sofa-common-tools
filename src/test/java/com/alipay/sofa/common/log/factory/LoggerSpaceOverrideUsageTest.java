...
public class LoggerSpaceOverrideUsageTest {
    ...
    public void testGetResource() throws IOException {
        ...
        Assert.assertEquals(url2, builder.getResourceByPriority(configFileUrls, propertyFileUrls));
