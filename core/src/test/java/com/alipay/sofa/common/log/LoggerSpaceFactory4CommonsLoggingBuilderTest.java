...
/**
 * LoggerSpaceFactory4CommonsLoggingBuilderTest
 * <p>
 * Created by yangguanchao on 17/1/18.
 */
public class LoggerSpaceFactory4CommonsLoggingBuilderTest extends AbstraceLogTestBase {
    ...
    public void testBuild() {
        AbstractLoggerSpaceFactory loggerSpaceFactory = loggerSpaceFactory4CommonsLoggingBuilder
            .build("com.alipay.sofa.rpc", this.getClass().getClassLoader());
    ...
    public void testLoggingLevelDebug() {
        ...
        LoggerSpaceFactory4CommonsLoggingBuilder loggerSpaceFactory4CommonsLoggingBuilder = new LoggerSpaceFactory4CommonsLoggingBuilder(
            new SpaceId("com.alipay.sofa.rpc"), spaceInfo);
    ...
    public void testLoggingLeveDynamicChange() throws Exception {
        ...
        AbstractLoggerSpaceFactory loggerSpaceFactory = loggerSpaceFactory4CommonsLoggingBuilder
            .build(LOG_SPACE_TEST, this.getClass().getClassLoader());
        ...
        //log4j1
        Assert.assertTrue(logger1 instanceof org.slf4j.impl.JCLLoggerAdapter && logger == logger1);
        Assert.assertTrue(logger.isErrorEnabled());
        Assert.assertTrue(logger.isWarnEnabled());
        Assert.assertTrue(logger.isInfoEnabled());
        Assert.assertTrue(logger.isDebugEnabled());
        ...
        //log4j1
        Assert.assertTrue(logger2 instanceof org.slf4j.impl.JCLLoggerAdapter && logger == logger2);
        Assert.assertTrue(logger.isErrorEnabled());
        Assert.assertTrue(logger.isWarnEnabled());
        Assert.assertTrue(logger.isInfoEnabled());
        Assert.assertTrue(logger.isDebugEnabled());
