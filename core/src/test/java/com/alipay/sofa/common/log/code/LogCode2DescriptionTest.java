...
public class LogCode2DescriptionTest {
    ...
    public void testDefaultLocale() {
        ...
        Assert.assertEquals("SOFA-TEST-00-00000: All is well", logCode2Description.convert("00-00000"));
        Assert.assertEquals("SOFA-TEST-01-00001: Some things goes wrong", logCode2Description.convert("01-00001"));
        Assert.assertEquals("SOFA-TEST-11-11111: Unknown Code", logCode2Description.convert("11-11111"));
    }
    ...
    public void testDirectConvert() {
        ...
        Assert.assertEquals("SOFA-TEST-00-00000: 一切都好", LogCode2Description.convert(COMPONENT_NAME, "00-00000"));
        Assert.assertEquals("SOFA-TEST-01-00001: 出现了问题", LogCode2Description.convert(COMPONENT_NAME, "01-00001"));
    }
}
